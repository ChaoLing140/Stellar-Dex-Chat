...
export function StellarWalletProvider({ children }: { children: ReactNode }) {
    const [connection, setConnection] = useState<StellarWalletConnection>(defaultConnection);
    ...
    return (
        <StellarWalletContext.Provider
            value={{ connection, connect, disconnect, signTx, isFreighterInstalled, isLoading, error }}
        >
            {children}
        </StellarWalletContext.Provider>
    );
